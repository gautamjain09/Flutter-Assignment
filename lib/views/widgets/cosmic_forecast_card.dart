    ...
    return Column(
      ...
      children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        widget
                                            .cosmicForecastModel.choghadiyaEnd,
                                        style: GoogleFonts.poppins(
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
                                          color: AppColors.whiteColor,
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        widget
                                            .cosmicForecastModel.rahukaalStart,
                                        style: GoogleFonts.poppins(
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
                                          color: AppColors.whiteColor,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        widget.cosmicForecastModel.rahukaalEnd,
                                        style: GoogleFonts.poppins(
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500,
                                          color: AppColors.whiteColor,
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          widget.cosmicForecastModel.luckyColor,
                                          style: GoogleFonts.poppins(
                                            fontSize: 18,
                                            fontWeight: FontWeight.w500,
                                            color: AppColors.whiteColor,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: AppColors.primaryMediumDarkColor,
            borderRadius: const BorderRadius.only(
              bottomLeft: Radius.circular(5),
              bottomRight: Radius.circular(5),
            ),
